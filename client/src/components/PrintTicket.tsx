    ...
    ({ session, settings }, ref) => {
        ...
        return (
            <>
                ...
                <div ref={ref} className="p-1 bg-white text-black font-mono text-[10pt] leading-normal" style={{ width: '100%', maxWidth: is80mm ? '76mm' : '52mm', boxSizing: 'border-box' }}>
                    ...
                    <div className="flex justify-center mb-2 overflow-hidden">
                        <Barcode
                            value={session.plate}
                            format="CODE128"
                            width={is80mm ? 2.0 : 1.3} // Optimized for thermal printers
                            height={40}
                            fontSize={12}
                            displayValue={true}
